...
const BASE_CARTES = [
  ...
  },
  {
    ...
    categorie: "Archéologie / Domestication",
    famille: "culture",
    titre: "Domestication du cheval sur les steppes pontiques",
    date: -3500,
    emoji: "🎭",
    image: "id-525.jpg",
    description_courte: "Sur les steppes au nord de la mer Noire, les premiers chevaux sont domestiqués pour le lait, la viande puis la monte.",
    description_longue: "Vers 3500 avant notre ère, les populations de la culture de Botai, dans l'actuel Kazakhstan, domestiquent le cheval sauvage des steppes eurasiennes. D'abord exploité pour sa viande et son lait, l'animal devient ensuite un moyen de transport qui bouleverse la mobilité humaine, le commerce et la guerre pour des millénaires. La domestication du cheval facilitera la diffusion des langues et technologies à travers tout le continent eurasien.",
    anecdote: "Des traces de graisse de lait de jument retrouvées sur des poteries de Botai constituent l'une des principales preuves archéologiques de cette domestication précoce.",
    fiabilite: "debattu",
    difficulte: "difficile",
    liens: [{"type": "wikipedia", "label": "Wikipédia : Domestication du cheval sur les steppes pontiques", "url": "https://fr.wikipedia.org/wiki/Domestication_du_cheval"}]
  },
  {
    id: 526,
    categorie: "Invention / Technologie",
    famille: "inventions",
    titre: "Début de la métallurgie du bronze",
    date: -3300,
    emoji: "⚙️",
    image: "id-526.jpg",
    description_courte: "L'alliage du cuivre et de l'étain donne naissance au bronze, plus dur et plus utile que le cuivre pur.",
    description_longue: "Au Proche-Orient, les artisans découvrent qu'en alliant du cuivre à de l'étain (ou parfois à l'arsenic), ils obtiennent un métal bien plus résistant que le cuivre seul : le bronze. Cette découverte ouvre l'Âge du bronze, période durant laquelle outils, armes et objets de prestige en bronze transforment l'agriculture, la guerre et le commerce à longue distance, l'étain devant souvent être importé de très loin.",
    anecdote: "La rareté de l'étain a créé certaines des premières routes commerciales de longue distance de l'histoire, reliant parfois des régions séparées par des milliers de kilomètres.",
    fiabilite: "avere",
    difficulte: "moyenne",
    liens: [{"type": "wikipedia", "label": "Wikipédia : Début de la métallurgie du bronze", "url": "https://fr.wikipedia.org/wiki/%C3%82ge_du_bronze"}]
  },
  {
    id: 527,
    categorie: "Histoire / Politique",
    famille: "histoire",
    titre: "Unification de l'Égypte par le pharaon Narmer",
    date: -3100,
    emoji: "📜",
    image: "id-527.jpg",
    description_courte: "Le roi Narmer unifie la Haute et la Basse-Égypte, fondant la première dynastie pharaonique.",
    description_longue: "Selon la tradition égyptienne, le roi Narmer (parfois identifié à Ménès) conquiert la Basse-Égypte et unifie le pays sous une seule couronne, fondant ainsi la première dynastie pharaonique. Cet événement fondateur est commémoré sur la célèbre palette de Narmer, l'une des plus anciennes représentations connues d'un souverain historique, où il porte tour à tour les couronnes des deux royaumes.",
    anecdote: "La palette de Narmer, découverte en 1898, est parfois considérée comme le plus ancien document historique au monde représentant un événement politique précis.",
    fiabilite: "debattu",
    difficulte: "difficile",
    liens: [{"type": "wikipedia", "label": "Wikipédia : Unification de l'Égypte par le pharaon Narmer", "url": "https://fr.wikipedia.org/wiki/Narmer"}]
  },
  {
    id: 528,
    categorie: "Histoire / Architecture",
    famille: "histoire",
    titre: "Uruk devient la plus grande ville du monde",
    date: -3100,
    emoji: "📜",
    image: "id-528.jpg",
    description_courte: "En Mésopotamie, la cité d'Uruk dépasse les 40 000 habitants et devient la première grande ville de l'histoire.",
    description_longue: "Sur les rives de l'Euphrate, la cité sumérienne d'Uruk connaît une croissance sans précédent et devient la plus grande agglomération humaine jamais construite jusque-là, avec des temples monumentaux comme l'Eanna. C'est aussi à Uruk que naît l'une des toutes premières écritures, l'écriture cunéiforme, née des besoins administratifs d'une société urbaine désormais complexe.",
    anecdote: "Le roi légendaire Gilgamesh, héros de la plus ancienne épopée connue, aurait régné sur Uruk, dont les remparts qu'il aurait fait construire sont mentionnés dans le récit.",
    fiabilite: "avere",
    difficulte: "difficile",
    liens: [{"type": "wikipedia", "label": "Wikipédia : Uruk devient la plus grande ville du monde", "url": "https://fr.wikipedia.org/wiki/Uruk"}]
  },
  {
    id: 529,
    categorie: "Architecture / Histoire",
    famille: "architecture",
    titre: "Construction de Stonehenge",
    date: -2500,
    emoji: "🏛️",
    image: "id-529.jpg",
    description_courte: "En Angleterre, d'immenses blocs de pierre sont dressés en cercle à Stonehenge, dans un but encore débattu.",
    description_longue: "Sur la plaine de Salisbury, en Angleterre, des générations successives de bâtisseurs néolithiques érigent le monument mégalithique de Stonehenge, dont les célèbres trilithes de pierre sarsen datent d'environ 2500 avant notre ère. Certains blocs bleus plus petits proviennent de carrières galloises distantes de près de 250 kilomètres, prouesse logistique remarquable pour l'époque. Sa fonction exacte — sanctuaire, observatoire astronomique, lieu funéraire — reste débattue.",
    anecdote: "Le monument est aligné avec une grande précision sur le lever du soleil au solstice d'été et son coucher au solstice d'hiver.",
    fiabilite: "debattu",
    difficulte: "moyenne",
    liens: [{"type": "wikipedia", "label": "Wikipédia : Construction de Stonehenge", "url": "https://fr.wikipedia.org/wiki/Stonehenge"}]
  },
  {
    id: 530,
    categorie: "Histoire / Archéologie",
    famille: "histoire",
    titre: "Apogée de la civilisation de la vallée de l'Indus",
    date: -2500,
    emoji: "📜",
    image: "id-530.jpg",
    description_courte: "Les cités de Mohenjo-daro et Harappa témoignent d'une civilisation urbaine avancée, dotée d'égouts et de plans en damier.",
    description_longue: "Dans la vallée de l'Indus, entre l'actuel Pakistan et le nord-ouest de l'Inde, la civilisation harappéenne atteint son apogée avec des cités comme Mohenjo-daro et Harappa, bâties selon un plan en damier remarquablement organisé, dotées de systèmes de drainage sophistiqués et de poids standardisés pour le commerce. Son écriture, composée de courts symboles, n'a toujours pas été déchiffrée à ce jour.",
    anecdote: "Mohenjo-daro possédait déjà, il y a 4500 ans, un réseau d'égouts couverts desservant presque chaque maison — un niveau d'hygiène urbaine que l'Europe ne retrouvera que des millénaires plus tard.",
    fiabilite: "avere",
    difficulte: "difficile",
    liens: [{"type": "wikipedia", "label": "Wikipédia : Apogée de la civilisation de la vallée de l'Indus", "url": "https://fr.wikipedia.org/wiki/Civilisation_de_la_vall%C3%A9e_de_l%27Indus"}]
  },
  {
    id: 531,
    categorie: "Histoire / Politique",
    famille: "histoire",
    titre: "Sargon d'Akkad fonde le premier empire de l'histoire",
    date: -2334,
    emoji: "📜",
    image: "id-531.jpg",
    description_courte: "Sargon d'Akkad conquiert les cités-États de Mésopotamie et fonde le premier empire multiethnique connu.",
    description_longue: "Parti d'origines modestes selon la légende, Sargon devient roi d'Akkad et conquiert l'ensemble des cités-États sumériennes, unifiant la Mésopotamie sous une seule autorité. L'empire akkadien qu'il fonde est considéré comme le premier empire multiethnique de l'histoire, gouverné depuis une capitale et administré par des fonctionnaires envoyés dans les provinces conquises, un modèle politique qui inspirera de nombreux empires ultérieurs.",
    anecdote: "Selon la légende, Sargon aurait été abandonné bébé dans un panier sur le fleuve avant d'être recueilli — un récit étonnamment proche de celui de Moïse, rédigé bien plus tard.",
    fiabilite: "debattu",
    difficulte: "difficile",
    liens: [{"type": "wikipedia", "label": "Wikipédia : Sargon d'Akkad fonde le premier empire de l'histoire", "url": "https://fr.wikipedia.org/wiki/Sargon_d%27Akkad"}]
  },
  {
    id: 532,
    categorie: "Nature / Catastrophe",
    famille: "nature",
    titre: "Éruption du volcan de Théra et déclin de la civilisation minoenne",
    date: -1600,
    emoji: "🌿",
    image: "id-532.jpg",
    description_courte: "L'une des plus violentes éruptions volcaniques de l'Antiquité dévaste l'île de Théra et fragilise la civilisation minoenne.",
    description_longue: "Sur l'île de Théra (l'actuelle Santorin), une éruption volcanique cataclysmique projette des cendres jusqu'en Égypte et déclenche des tsunamis dévastateurs en Méditerranée orientale. L'événement porte un coup sévère à la civilisation minoenne de Crète voisine, déjà fragilisée, et est parfois associé par certains chercheurs au mythe platonicien de l'Atlantide engloutie.",
    anecdote: "La ville portuaire d'Akrotiri, ensevelie sous les cendres comme une Pompéi préhistorique, a été retrouvée remarquablement bien conservée, sans qu'aucun corps humain n'y ait été découvert — ses habitants ayant eu le temps de fuir.",
    fiabilite: "debattu",
    difficulte: "difficile",
    liens: [{"type": "wikipedia", "label": "Wikipédia : Éruption du volcan de Théra et déclin de la civilisation minoenne", "url": "https://fr.wikipedia.org/wiki/%C3%89ruption_minoenne"}]
  },
  {
    id: 533,
    categorie: "Guerre / Antiquité",
    famille: "guerre",
    titre: "Bataille de Kadesh, premier traité de paix écrit de l'histoire",
    date: -1274,
    emoji: "⚔️",
    image: "id-533.jpg",
    description_courte: "Égyptiens et Hittites s'affrontent à Kadesh, avant de signer le plus ancien traité de paix connu.",
    description_longue: "Le pharaon Ramsès II affronte l'empire hittite près de la ville de Kadesh, en Syrie actuelle, lors de l'une des plus grandes batailles de chars de l'Antiquité. Sans vainqueur décisif, le conflit se conclut seize ans plus tard par un traité de paix avec le roi hittite Hattusili III, dont une copie gravée est aujourd'hui exposée au siège des Nations unies comme symbole de diplomatie.",
    anecdote: "Une réplique du traité de Kadesh est affichée au siège de l'ONU à New York, en hommage au plus ancien accord de paix international dont le texte intégral nous soit parvenu.",
    fiabilite: "avere",
    difficulte: "difficile",
    liens: [{"type": "wikipedia", "label": "Wikipédia : Bataille de Kadesh, premier traité de paix écrit de l'histoire", "url": "https://fr.wikipedia.org/wiki/Bataille_de_Qadesh"}]
  },
  {
    id: 534,
    categorie: "Mythologie / Grèce",
    ...
    emoji: "🐉",
    image: "id-534.jpg",
    description_courte: "Selon la légende grecque, une coalition achéenne assiège et détruit la cité de Troie pour reprendre la belle Hélène.",
    description_longue: "Racontée dans l'Iliade d'Homère, la guerre de Troie oppose une coalition de royaumes grecs à la cité de Troie, en Asie Mineure, après l'enlèvement d'Hélène par le prince troyen Pâris. Le conflit s'achève par la ruse du cheval de bois et la destruction de la ville. Si l'historicité précise du récit reste débattue, des fouilles archéologiques ont bien mis au jour plusieurs cités successives sur le site présumé de Troie.",
    anecdote: "L'archéologue amateur allemand Heinrich Schliemann affirma avoir retrouvé le site de Troie en 1870 en suivant le texte d'Homère presque à la lettre, convaincant nombre de sceptiques.",
    fiabilite: "legende",
    difficulte: "moyenne",
    liens: [{"type": "wikipedia", "label": "Wikipédia : La guerre de Troie", "url": "https://fr.wikipedia.org/wiki/Guerre_de_Troie"}]
  },
  {
    id: 535,
    categorie: "Histoire / Société",
    famille: "histoire",
    titre: "Effondrement des civilisations de l'âge du bronze",
    date: -1200,
    emoji: "📜",
    image: "id-535.jpg",
    description_courte: "En quelques décennies, la plupart des grands royaumes de Méditerranée orientale s'effondrent brutalement.",
    description_longue: "Entre environ 1200 et 1150 avant notre ère, une vague de destructions et de crises frappe presque simultanément l'Égypte, les Hittites, Mycènes et de nombreuses cités du Levant. Invasions des mystérieux « peuples de la mer », sécheresses, tremblements de terre et ruptures des routes commerciales sont autant de causes avancées pour expliquer cet effondrement, qui plonge une grande partie de la région dans un « âge sombre » de plusieurs siècles.",
    anecdote: "L'empire hittite, l'une des plus grandes puissances de son temps, disparaît si soudainement que sa capitale Hattusa est retrouvée abandonnée, comme figée en plein exode.",
    fiabilite: "debattu",
    difficulte: "difficile",
    liens: [{"type": "wikipedia", "label": "Wikipédia : Effondrement des civilisations de l'âge du bronze", "url": "https://fr.wikipedia.org/wiki/Effondrement_de_l%27%C3%A2ge_du_bronze"}]
  },
  {
    id: 536,
    categorie: "Invention / Écriture",
    famille: "inventions",
    titre: "Invention de l'alphabet phénicien",
    date: -1050,
    emoji: "⚙️",
    image: "id-536.jpg",
    description_courte: "Les marchands phéniciens diffusent un alphabet de 22 signes consonantiques, ancêtre de la plupart des alphabets actuels.",
    description_longue: "Simplifiant les systèmes d'écriture complexes de leurs voisins, les Phéniciens développent un alphabet purement consonantique de 22 signes, bien plus facile à apprendre que les hiéroglyphes égyptiens ou l'écriture cunéiforme. Diffusé par les marchands phéniciens sur tout le pourtour méditerranéen grâce à leur intense activité commerciale, il donnera naissance à l'alphabet grec, puis, par son intermédiaire, à l'alphabet latin utilisé aujourd'hui par des milliards de personnes.",
    anecdote: "Le mot « alphabet » lui-même vient des deux premières lettres phéniciennes, aleph et beth, devenues alpha et bêta en grec.",
    fiabilite: "avere",
    difficulte: "moyenne",
    liens: [{"type": "wikipedia", "label": "Wikipédia : Invention de l'alphabet phénicien", "url": "https://fr.wikipedia.org/wiki/Alphabet_ph%C3%A9nicien"}]
  },
  {
    id: 537,
    categorie: "Histoire / Politique",
    famille: "histoire",
    titre: "Fondation de Carthage par les Phéniciens",
    date: -814,
    emoji: "📜",
    image: "id-537.jpg",
    description_courte: "Des colons phéniciens venus de Tyr fondent Carthage, future grande rivale de Rome en Méditerranée.",
    description_longue: "Selon la tradition, la reine Didon (ou Élissa), fuyant la cité phénicienne de Tyr, fonde Carthage sur les côtes de l'actuelle Tunisie. La ville devient rapidement une puissante cité marchande dominant le commerce en Méditerranée occidentale, avant de s'opposer à Rome lors des célèbres guerres puniques, qui se termineront par sa destruction totale en 146 avant notre ère.",
    anecdote: "Selon la légende, Didon aurait obtenu son territoire en négociant l'espace couvert par la peau d'un seul bœuf — qu'elle découpa alors en fines lanières pour entourer une colline entière.",
    fiabilite: "debattu",
    difficulte: "moyenne",
    liens: [{"type": "wikipedia", "label": "Wikipédia : Fondation de Carthage par les Phéniciens", "url": "https://fr.wikipedia.org/wiki/Carthage"}]
  },
  {
    id: 538,
    categorie: "Histoire / Droit",
    famille: "histoire",
    titre: "Dracon rédige les premières lois écrites d'Athènes",
    date: -621,
    emoji: "📜",
    image: "id-538.jpg",
    description_courte: "Le législateur Dracon publie le premier code de lois écrit d'Athènes, d'une sévérité extrême.",
    description_longue: "Face aux abus de la justice orale rendue arbitrairement par l'aristocratie, l'archonte Dracon rédige le premier code de lois écrites d'Athènes, rendant la justice plus prévisible mais d'une sévérité redoutable : de nombreux délits, même mineurs, y sont punis de mort. La plupart de ces lois seront abrogées une génération plus tard par les réformes plus modérées de Solon.",
    anecdote: "C'est de ce code que vient l'adjectif « draconien », toujours utilisé aujourd'hui pour qualifier des mesures d'une sévérité excessive.",
    fiabilite: "avere",
    difficulte: "difficile",
    liens: [{"type": "wikipedia", "label": "Wikipédia : Dracon rédige les premières lois écrites d'Athènes", "url": "https://fr.wikipedia.org/wiki/Dracon"}]
  },
  {
    id: 539,
    categorie: "Mythologie / Mésopotamie",
    famille: "mythologie",
    titre: "Nabuchodonosor II et les jardins suspendus de Babylone",
    date: -600,
    emoji: "🐉",
    image: "id-539.jpg",
    description_courte: "Le roi Nabuchodonosor II fait de Babylone une cité magnifique, à qui la légende attribue de célèbres jardins suspendus.",
    description_longue: "Sous le règne de Nabuchodonosor II, Babylone devient l'une des plus grandes et des plus riches villes du monde antique, ornée de la porte d'Ishtar et de monumentales ziggourats. La tradition grecque lui attribue également la construction des jardins suspendus, l'une des sept merveilles du monde antique, bien qu'aucune trace archéologique certaine n'en ait jamais été retrouvée à Babylone même.",
    anecdote: "Certains historiens pensent aujourd'hui que les fameux jardins suspendus se trouvaient en réalité non pas à Babylone mais dans la ville rivale de Ninive, et auraient été construits par le roi assyrien Sennachérib.",
    fiabilite: "legende",
    difficulte: "moyenne",
    liens: [{"type": "wikipedia", "label": "Wikipédia : Nabuchodonosor II et les jardins suspendus de Babylone", "url": "https://fr.wikipedia.org/wiki/Jardins_suspendus_de_Babylone"}]
  },
  {
    id: 540,
    categorie: "Histoire / Politique",
    famille: "histoire",
    titre: "Cyrus le Grand fonde l'Empire perse achéménide",
    date: -550,
    emoji: "📜",
    image: "id-540.jpg",
    description_courte: "Cyrus le Grand unifie les Mèdes et les Perses et fonde le plus vaste empire connu jusqu'alors.",
    description_longue: "En quelques décennies, Cyrus II, dit le Grand, conquiert la Médie, la Lydie puis Babylone, fondant l'Empire perse achéménide, qui s'étendra à son apogée de la Grèce à l'Inde. Il est aussi connu pour avoir autorisé le retour des exilés juifs de Babylone vers Jérusalem, un geste de tolérance religieuse exceptionnel pour son époque, célébré dans la Bible hébraïque.",
    anecdote: "Le Cylindre de Cyrus, un texte babylonien célébrant sa clémence envers les peuples conquis, est parfois présenté, non sans débat parmi les historiens, comme l'une des premières déclarations des droits de l'homme.",
    fiabilite: "avere",
    difficulte: "moyenne",
    liens: [{"type": "wikipedia", "label": "Wikipédia : Cyrus le Grand fonde l'Empire perse achéménide", "url": "https://fr.wikipedia.org/wiki/Cyrus_II"}]
  },
  {
    id: 541,
    categorie: "Histoire / Droit",
    famille: "histoire",
    titre: "Solon réforme les lois d'Athènes",
    date: -594,
    emoji: "📜",
    image: "id-541.jpg",
    description_courte: "L'archonte Solon abolit l'esclavage pour dettes et pose les bases de la future démocratie athénienne.",
    description_longue: "Nommé archonte avec des pouvoirs exceptionnels pour apaiser une crise sociale profonde, Solon abolit l'esclavage pour dettes, réorganise la société athénienne en fonction de la richesse plutôt que de la seule naissance, et crée de nouvelles institutions judiciaires accessibles à davantage de citoyens. Ses réformes, bien qu'incomplètes, ouvrent la voie aux réformes démocratiques de Clisthène un siècle plus tard.",
    anecdote: "Une fois ses réformes votées, Solon aurait quitté Athènes pendant dix ans, prétextant des voyages, pour empêcher que ses concitoyens ne le supplient de les modifier.",
    fiabilite: "avere",
    difficulte: "difficile",
    liens: [{"type": "wikipedia", "label": "Wikipédia : Solon réforme les lois d'Athènes", "url": "https://fr.wikipedia.org/wiki/Solon"}]
  },
  {
    id: 542,
    categorie: "Guerre / Antiquité",
    famille: "guerre",
    titre: "Bataille de Marathon",
    date: -490,
    emoji: "⚔️",
    image: "id-542.jpg",
    description_courte: "Les hoplites athéniens repoussent contre toute attente la première invasion perse de la Grèce.",
    description_longue: "Sur la plaine de Marathon, une armée athénienne très largement inférieure en nombre inflige une défaite retentissante à l'armée perse de Darius Ier, stoppant net sa première tentative d'invasion de la Grèce continentale. Cette victoire renforce durablement la confiance athénienne et le prestige naissant de la démocratie face à l'empire perse.",
    anecdote: "Selon une légende popularisée bien plus tard, le soldat Phidippidès aurait couru sans s'arrêter jusqu'à Athènes pour annoncer la victoire avant de s'effondrer mort d'épuisement — origine du nom de l'épreuve sportive du marathon.",
    fiabilite: "avere",
    difficulte: "moyenne",
    liens: [{"type": "wikipedia", "label": "Wikipédia : Bataille de Marathon", "url": "https://fr.wikipedia.org/wiki/Bataille_de_Marathon"}]
  },
  {
    id: 543,
    categorie: "Architecture / Histoire",
    famille: "architecture",
    titre: "Construction du Parthénon à Athènes",
    date: -447,
    emoji: "🏛️",
    image: "id-543.jpg",
    description_courte: "Sur l'Acropole d'Athènes, le Parthénon est édifié en l'honneur de la déesse Athéna.",
    description_longue: "Sous l'impulsion du stratège Périclès, les architectes Ictinos et Callicratès élèvent sur l'Acropole d'Athènes le Parthénon, temple dédié à la déesse Athéna et chef-d'œuvre de l'architecture dorique. Orné de sculptures du célèbre Phidias, il devient le symbole même de l'âge d'or athénien et de l'esthétique classique grecque, dont l'influence perdure dans l'architecture occidentale plus de deux mille ans plus tard.",
    anecdote: "Le Parthénon a servi tour à tour de temple païen, d'église chrétienne, de mosquée ottomane, puis de dépôt de munitions — c'est une explosion accidentelle de ces dernières, en 1687, qui a soufflé une grande partie de sa toiture.",
    fiabilite: "avere",
    difficulte: "moyenne",
    liens: [{"type": "wikipedia", "label": "Wikipédia : Construction du Parthénon à Athènes", "url": "https://fr.wikipedia.org/wiki/Parth%C3%A9non"}]
  },
  {
    id: 544,
    categorie: "Histoire / Philosophie",
    famille: "histoire",
    titre: "Procès et mort de Socrate",
    date: -399,
    emoji: "📜",
    image: "id-544.jpg",
    description_courte: "Accusé de corrompre la jeunesse athénienne, le philosophe Socrate est condamné à boire la ciguë.",
    description_longue: "Accusé d'impiété et de corrompre la jeunesse par ses questionnements incessants, le philosophe Socrate est jugé par un tribunal populaire athénien et condamné à mort. Refusant de fuir malgré la possibilité de s'échapper, il boit la ciguë entouré de ses disciples, dont Platon, qui transmettra sa pensée à la postérité alors que Socrate lui-même n'a jamais rien écrit.",
    anecdote: "Socrate aurait pu échapper à la mort en proposant sa propre peine de substitution, mais il suggéra ironiquement d'être nourri gratuitement au Prytanée pour le reste de sa vie, ce qui acheva d'irriter ses juges.",
    fiabilite: "avere",
    difficulte: "moyenne",
    liens: [{"type": "wikipedia", "label": "Wikipédia : Procès et mort de Socrate", "url": "https://fr.wikipedia.org/wiki/Proc%C3%A8s_de_Socrate"}]
  },
  {
    id: 545,
    categorie: "Histoire / Science",
    famille: "histoire",
    titre: "Fondation de la bibliothèque d'Alexandrie",
    date: -295,
    emoji: "📜",
    image: "id-545.jpg",
    description_courte: "Les Ptolémées fondent à Alexandrie la plus grande bibliothèque du monde antique.",
    description_longue: "Sous l'impulsion des rois Ptolémée Ier puis Ptolémée II, la bibliothèque d'Alexandrie est fondée avec l'ambition de rassembler l'ensemble du savoir écrit connu, attirant savants et érudits de toute la Méditerranée. Rattachée au Mouseion, véritable centre de recherche antique, elle aurait compté plusieurs centaines de milliers de rouleaux avant sa disparition progressive, encore entourée de nombreuses légendes.",
    anecdote: "Selon une tradition rapportée par plusieurs auteurs antiques, tout navire faisant escale à Alexandrie devait remettre ses manuscrits pour qu'ils soient copiés par les scribes de la bibliothèque avant d'être rendus à leurs propriétaires.",
    fiabilite: "debattu",
    difficulte: "moyenne",
    liens: [{"type": "wikipedia", "label": "Wikipédia : Fondation de la bibliothèque d'Alexandrie", "url": "https://fr.wikipedia.org/wiki/Biblioth%C3%A8que_d%27Alexandrie"}]
  },
  {
    id: 546,
    categorie: "Science / Mathématiques",
    famille: "science",
    titre: "Euclide publie les Éléments, fondement de la géométrie",
    date: -300,
    emoji: "🔬",
    image: "id-546.jpg",
    description_courte: "À Alexandrie, Euclide rassemble dans les Éléments les bases logiques de toute la géométrie antique.",
    description_longue: "Dans son traité en treize livres intitulé les Éléments, le mathématicien Euclide organise de façon rigoureusement logique l'ensemble des connaissances géométriques de son temps, à partir d'un petit nombre d'axiomes et de postulats. Cet ouvrage restera le manuel de référence de la géométrie en Occident pendant plus de deux mille ans, influençant jusqu'à la méthode scientifique moderne.",
    anecdote: "Les Éléments d'Euclide sont, après la Bible, l'un des ouvrages ayant connu le plus grand nombre d'éditions imprimées différentes dans l'histoire.",
    fiabilite: "debattu",
    difficulte: "difficile",
    liens: [{"type": "wikipedia", "label": "Wikipédia : Euclide publie les Éléments, fondement de la géométrie", "url": "https://fr.wikipedia.org/wiki/%C3%89l%C3%A9ments_d%27Euclide"}]
  },
  {
    id: 547,
    categorie: "Histoire / Politique",
    famille: "histoire",
    titre: "Qin Shi Huang unifie la Chine et crée l'armée en terre cuite",
    date: -221,
    emoji: "📜",
    image: "id-547.jpg",
    description_courte: "Le roi Ying Zheng unifie les royaumes chinois en guerre et devient le premier empereur de Chine.",
    description_longue: "Après avoir conquis un à un les six autres royaumes chinois rivaux, le roi de Qin, Ying Zheng, proclame l'unification de la Chine sous le nom de Qin Shi Huang, littéralement « premier empereur ». Il standardise l'écriture, la monnaie et les mesures, relie plusieurs murailles défensives préexistantes, et fait édifier pour son mausolée une armée de plusieurs milliers de soldats en terre cuite grandeur nature.",
    anecdote: "L'armée en terre cuite, oubliée pendant plus de deux mille ans, n'a été redécouverte qu'en 1974 par des paysans creusant un puits.",
    fiabilite: "avere",
    difficulte: "moyenne",
    liens: [{"type": "wikipedia", "label": "Wikipédia : Qin Shi Huang unifie la Chine et crée l'armée en terre cuite", "url": "https://fr.wikipedia.org/wiki/Qin_Shi_Huang"}]
  },
  {
    id: 548,
    categorie: "Science / Physique",
    famille: "science",
    titre: "Archimède découvre le principe de la poussée",
    date: -250,
    emoji: "🔬",
    image: "id-548.jpg",
    description_courte: "En observant l'eau déborder de son bain, Archimède formule le principe fondamental de la flottabilité des corps.",
    description_longue: "Chargé de vérifier si la couronne du roi Hiéron II de Syracuse était en or pur sans l'endommager, le savant Archimède aurait eu une illumination en observant le niveau de l'eau monter dans sa baignoire : tout corps plongé dans un liquide subit une poussée égale au poids du volume de liquide déplacé. Ce principe fondateur de l'hydrostatique porte aujourd'hui son nom.",
    anecdote: "Archimède aurait bondi de son bain en criant « Eurêka ! » (« J'ai trouvé ! ») et couru nu à travers les rues de Syracuse tant son excitation était grande, selon l'anecdote rapportée par l'architecte romain Vitruve.",
    fiabilite: "legende",
    difficulte: "moyenne",
    liens: [{"type": "wikipedia", "label": "Wikipédia : Archimède découvre le principe de la poussée", "url": "https://fr.wikipedia.org/wiki/Pouss%C3%A9e_d%27Archim%C3%A8de"}]
  },
  {
    id: 549,
    categorie: "Histoire / Religion",
    famille: "histoire",
    titre: "L'empereur Ashoka grave ses édits bouddhistes en Inde",
    date: -250,
    emoji: "📜",
    image: "id-549.jpg",
    description_courte: "Bouleversé par les massacres d'une guerre de conquête, l'empereur Ashoka se convertit au bouddhisme et grave ses préceptes sur des piliers.",
    description_longue: "Horrifié par les centaines de milliers de morts causées par sa conquête du royaume de Kalinga, l'empereur maurya Ashoka se convertit au bouddhisme et renonce à toute nouvelle guerre de conquête. Il fait graver sur des piliers et des rochers, dans tout son immense empire, des édits prônant la non-violence, la tolérance religieuse et le bien-être de ses sujets — l'un des plus anciens exemples connus de communication de masse par un État.",
    anecdote: "Le pilier de lion d'Ashoka, érigé à Sarnath, a été choisi en 1950 comme emblème officiel de la République de l'Inde et figure toujours sur son drapeau et sa monnaie.",
    fiabilite: "avere",
    difficulte: "difficile",
    liens: [{"type": "wikipedia", "label": "Wikipédia : L'empereur Ashoka grave ses édits bouddhistes en Inde", "url": "https://fr.wikipedia.org/wiki/A%C5%9Boka"}]
  },
  {
    id: 550,
    categorie: "Histoire / Politique",
    famille: "histoire",
    titre: "Auguste devient le premier empereur romain",
    date: -27,
    emoji: "📜",
    image: "id-550.jpg",
    description_courte: "Octave reçoit du Sénat romain le titre d'Auguste et devient de fait le premier empereur de Rome.",
    description_longue: "Après avoir vaincu Marc Antoine et Cléopâtre à la bataille d'Actium, Octave, petit-neveu et fils adoptif de Jules César, restitue en apparence ses pouvoirs exceptionnels au Sénat romain, qui lui décerne en retour le titre honorifique d'Auguste. Il inaugure ainsi le Principat, un régime qui préserve les formes républicaines tout en concentrant dans les faits tous les pouvoirs entre les mains d'un seul homme, ouvrant plus de deux siècles de paix romaine relative, la Pax Romana.",
    anecdote: "Le mois d'août (« August » en anglais) tire directement son nom d'Auguste, qui voulut un mois aussi prestigieux que le « juillet » nommé en l'honneur de Jules César.",
    fiabilite: "avere",
    difficulte: "moyenne",
    liens: [{"type": "wikipedia", "label": "Wikipédia : Auguste devient le premier empereur romain", "url": "https://fr.wikipedia.org/wiki/Octavianus"}]
  },
  {
    id: 551,
    categorie: "Histoire / Société",
    famille: "histoire",
    titre: "Grand incendie de Rome sous Néron",
    date: 64,
    emoji: "📜",
    image: "id-551.jpg",
    description_courte: "Un gigantesque incendie ravage Rome pendant six jours, alimentant la légende noire de l'empereur Néron.",
    description_longue: "Un incendie d'une ampleur exceptionnelle se déclare dans les quartiers commerçants de Rome et ravage pendant près d'une semaine une grande partie de la ville, détruisant plusieurs de ses quatorze régions. Bien que l'empereur Néron ait organisé les secours et financé la reconstruction, la rumeur populaire l'accuse d'avoir lui-même provoqué l'incendie pour dégager un espace destiné à son palais, le Domus Aurea — accusation que les historiens modernes jugent largement infondée.",
    anecdote: "Contrairement à la légende tenace, Néron n'a très probablement jamais « joué de la lyre pendant que Rome brûlait » : selon les sources antiques elles-mêmes, il se trouvait à plusieurs dizaines de kilomètres de Rome au moment où l'incendie s'est déclaré.",
    fiabilite: "debattu",
    difficulte: "moyenne",
    liens: [{"type": "wikipedia", "label": "Wikipédia : Grand incendie de Rome sous Néron", "url": "https://fr.wikipedia.org/wiki/Grand_incendie_de_Rome"}]
  },
  {
    id: 552,
    categorie: "Architecture / Histoire",
    famille: "architecture",
    titre: "Construction du Panthéon de Rome",
    date: 126,
    emoji: "🏛️",
    image: "id-552.jpg",
    description_courte: "L'empereur Hadrien fait reconstruire le Panthéon, dont la coupole en béton reste un exploit technique inégalé pendant des siècles.",
    description_longue: "Reconstruit sur ordre de l'empereur Hadrien après la destruction d'un premier temple, le Panthéon de Rome est coiffé d'une immense coupole en béton, restée la plus grande coupole non armée du monde pendant près de dix-huit siècles. Son oculus central, ouvert directement sur le ciel, éclaire l'intérieur du bâtiment et laisse passer la pluie, évacuée par un discret système de drainage au sol.",
    anecdote: "Le diamètre de la coupole du Panthéon est exactement égal à sa hauteur au-dessus du sol, formant une sphère parfaite inscrite dans le bâtiment — une prouesse géométrique et technique toujours étudiée par les architectes aujourd'hui.",
    fiabilite: "avere",
    difficulte: "moyenne",
    liens: [{"type": "wikipedia", "label": "Wikipédia : Construction du Panthéon de Rome", "url": "https://fr.wikipedia.org/wiki/Panth%C3%A9on_(Rome)"}]
  },
  {
    id: 553,
    categorie: "Histoire / Droit",
    famille: "histoire",
    titre: "L'édit de Caracalla étend la citoyenneté romaine à tout l'Empire",
    date: 212,
    emoji: "📜",
    image: "id-553.jpg",
    description_courte: "L'empereur Caracalla accorde la citoyenneté romaine à presque tous les hommes libres de l'Empire.",
    description_longue: "Par l'édit connu sous le nom de Constitutio Antoniniana, l'empereur Caracalla accorde la citoyenneté romaine à la quasi-totalité des hommes libres résidant dans l'Empire, jusque-là un privilège réservé à une minorité. Si les historiens débattent encore de ses motivations exactes — élargir l'assiette fiscale ou renforcer l'unité de l'Empire —, cette réforme transforme durablement l'identité juridique et politique du monde romain.",
    anecdote: "Le texte original de l'édit, gravé sur papyrus, n'a été redécouvert qu'en 1902 lors de fouilles en Égypte, permettant de confirmer précisément son contenu resté longtemps incertain.",
    fiabilite: "avere",
    difficulte: "difficile",
    liens: [{"type": "wikipedia", "label": "Wikipédia : L'édit de Caracalla étend la citoyenneté romaine à tout l'Empire", "url": "https://fr.wikipedia.org/wiki/Constitutio_Antoniniana"}]
  },
  {
    id: 554,
    categorie: "Histoire / Religion",
    famille: "histoire",
    titre: "Concile de Nicée, premier concile œcuménique chrétien",
    date: 325,
    emoji: "📜",
    image: "id-554.jpg",
    description_courte: "Convoqué par l'empereur Constantin, le concile de Nicée fixe les bases doctrinales communes du christianisme.",
    description_longue: "Pour mettre fin aux querelles théologiques qui divisent l'Église naissante, notamment sur la nature du Christ face à l'arianisme, l'empereur Constantin convoque à Nicée le premier concile réunissant des évêques de tout l'Empire romain. L'assemblée y rédige le Credo de Nicée, toujours récité aujourd'hui dans de nombreuses Églises chrétiennes, et pose ainsi les fondations d'une doctrine chrétienne commune.",
    anecdote: "Selon une tradition tardive, saint Nicolas — futur inspirateur du Père Noël — aurait assisté au concile et giflé l'hérétique Arius en pleine séance, un épisode absent des sources historiques fiables mais resté très populaire.",
    fiabilite: "avere",
    difficulte: "difficile",
    liens: [{"type": "wikipedia", "label": "Wikipédia : Concile de Nicée, premier concile œcuménique chrétien", "url": "https://fr.wikipedia.org/wiki/Premier_concile_de_Nic%C3%A9e"}]
  },
  {
    id: 555,
    categorie: "Guerre / Histoire",
    famille: "guerre",
    titre: "Attila et les Huns envahissent l'Europe",
    date: 451,
    emoji: "⚔️",
    image: "id-555.jpg",
    description_courte: "Attila, roi des Huns, envahit la Gaule romaine avant d'être arrêté aux champs Catalauniques.",
    description_longue: "Surnommé le « fléau de Dieu », le roi des Huns Attila mène ses cavaliers à travers la Gaule romaine, semant la destruction sur son passage, avant d'être finalement stoppé à la bataille des champs Catalauniques par une coalition inédite de légions romaines et de peuples wisigoths, jusque-là rivaux. Sa mort soudaine, deux ans plus tard, précipite l'effondrement de son empire éphémère.",
    anecdote: "Selon la légende, Attila serait mort d'une hémorragie nasale la nuit de son mariage avec une nouvelle épouse, un trépas jugé si peu glorieux pour un tel conquérant qu'il alimenta longtemps les soupçons d'empoisonnement.",
    fiabilite: "avere",
    difficulte: "moyenne",
    liens: [{"type": "wikipedia", "label": "Wikipédia : Attila et les Huns envahissent l'Europe", "url": "https://fr.wikipedia.org/wiki/Attila"}]
  },
  {
    id: 556,
    categorie: "Histoire / Politique",
    famille: "histoire",
    titre: "Fondation de la dynastie Han en Chine",
    date: -206,
    emoji: "📜",
    image: "id-556.jpg",
    description_courte: "Liu Bang fonde la dynastie Han, qui façonnera durablement la civilisation chinoise pendant quatre siècles.",
    description_longue: "Après la chute rapide de la dynastie Qin, l'ancien paysan devenu chef militaire Liu Bang l'emporte dans la guerre civile qui s'ensuit et fonde la dynastie Han, qui régnera sur la Chine pendant environ quatre cents ans. Cette période voit l'expansion territoriale de la Chine, l'ouverture de la route de la soie et une telle prospérité culturelle que les Chinois se désignent encore aujourd'hui comme le « peuple Han ».",
    anecdote: "Le nom « Han » est aujourd'hui encore utilisé pour désigner l'ethnie majoritaire de Chine, qui représente environ 90 % de la population du pays.",
    fiabilite: "avere",
    difficulte: "difficile",
    liens: [{"type": "wikipedia", "label": "Wikipédia : Fondation de la dynastie Han en Chine", "url": "https://fr.wikipedia.org/wiki/Dynastie_Han"}]
  },
  {
    id: 557,
    categorie: "Architecture / Histoire",
    famille: "architecture",
    titre: "Construction de la pyramide du Soleil à Teotihuacan",
    date: 100,
    emoji: "🏛️",
    image: "id-557.jpg",
    description_courte: "Près de l'actuelle Mexico, la civilisation de Teotihuacan bâtit l'une des plus grandes pyramides du monde précolombien.",
    description_longue: "Dans la vallée de Mexico, la mystérieuse civilisation de Teotihuacan édifie la pyramide du Soleil, l'une des plus vastes structures pyramidales jamais construites en Amérique. Bâtisseurs d'une cité qui comptera jusqu'à 150 000 habitants à son apogée, ils laisseront un site si impressionnant que les Aztèques, l'ayant découvert des siècles plus tard alors qu'il était déjà abandonné, le considéraient comme le lieu de naissance des dieux.",
    anecdote: "On ignore toujours quelle langue parlaient les bâtisseurs de Teotihuacan : le nom même de la cité, qui signifie « lieu où les hommes deviennent des dieux », lui a été donné bien plus tard par les Aztèques, dans leur propre langue, le nahuatl.",
    fiabilite: "debattu",
    difficulte: "difficile",
    liens: [{"type": "wikipedia", "label": "Wikipédia : Construction de la pyramide du Soleil à Teotihuacan", "url": "https://fr.wikipedia.org/wiki/Teotihuacan"}]
  },
  {
    id: 558,
    categorie: "Sport / Histoire",
    famille: "sport",
    titre: "Apparition du jeu de balle rituel mésoaméricain",
    date: -1400,
    emoji: "🏅",
    image: "id-558.jpg",
    description_courte: "Dans l'Amérique précolombienne, un jeu de balle rituel joué sur des terrains dédiés se répand pendant plus de trois mille ans.",
    description_longue: "Dans la région du Mexique et de l'Amérique centrale actuels, les civilisations précolombiennes développent un jeu de balle rituel joué avec une balle de caoutchouc massif sur des terrains spécialement aménagés, bordés de murs en pierre. Pratiqué aussi bien pour le sport que pour trancher des conflits politiques ou accomplir des rites religieux, ce jeu se transmet pendant plus de trois millénaires, des Olmèques aux Aztèques.",
    anecdote: "Selon certaines sources, les perdants de certaines parties rituelles particulièrement importantes pouvaient être sacrifiés aux dieux — bien que l'ampleur réelle de cette pratique reste débattue parmi les archéologues.",
    fiabilite: "debattu",
    difficulte: "difficile",
    liens: [{"type": "wikipedia", "label": "Wikipédia : Apparition du jeu de balle rituel mésoaméricain", "url": "https://fr.wikipedia.org/wiki/Jeu_de_balle_(M%C3%A9soam%C3%A9rique)"}]
  },
  {
    id: 559,
    categorie: "Science / Mathématiques",
    famille: "science",
    titre: "Aryabhata décrit le système décimal et le zéro en Inde",
    date: 499,
    emoji: "🔬",
    image: "id-559.jpg",
    description_courte: "Le mathématicien indien Aryabhata expose un système de numération décimale positionnelle, bientôt complété par le concept de zéro.",
    description_longue: "Dans son traité l'Âryabhatîya, le savant indien Aryabhata expose un système de numération décimale positionnelle d'une redoutable efficacité, où la valeur d'un chiffre dépend de sa position. Ce système, qu'un autre savant indien complètera bientôt par le concept du zéro comme chiffre à part entière, sera transmis au monde arabo-musulman puis à l'Europe, où il remplacera progressivement les chiffres romains pour devenir la numération utilisée aujourd'hui dans le monde entier.",
    anecdote: "Les chiffres que nous appelons aujourd'hui « arabes » sont en réalité d'origine indienne : les savants du monde arabo-musulman, qui les ont transmis à l'Europe, les appellent eux-mêmes « chiffres indiens ».",
    fiabilite: "debattu",
    difficulte: "difficile",
    liens: [{"type": "wikipedia", "label": "Wikipédia : Aryabhata décrit le système décimal et le zéro en Inde", "url": "https://fr.wikipedia.org/wiki/Aryabhata"}]
  },
  {
    id: 560,
    categorie: "Histoire / Religion",
    famille: "histoire",
    titre: "Mahomet reçoit sa première révélation",
    date: 610,
    emoji: "📜",
    image: "id-560.jpg",
    description_courte: "Dans une grotte près de La Mecque, Mahomet reçoit ce que les musulmans considèrent comme la première révélation du Coran.",
    description_longue: "Retiré en méditation dans la grotte de Hira, près de La Mecque, le marchand arabe Mahomet reçoit, selon la tradition musulmane, la visite de l'ange Gabriel qui lui transmet les premiers versets du Coran. Cet événement marque le début de sa mission prophétique et la naissance de l'islam, religion qui rassemblera en quelques décennies l'ensemble de la péninsule arabique avant de s'étendre bien au-delà.",
    anecdote: "Le calendrier musulman ne débute pas à cette révélation mais douze ans plus tard, avec l'Hégire, le départ de Mahomet de La Mecque vers Médine en 622.",
    fiabilite: "avere",
    difficulte: "moyenne",
    liens: [{"type": "wikipedia", "label": "Wikipédia : Mahomet reçoit sa première révélation", "url": "https://fr.wikipedia.org/wiki/Mahomet"}]
  },
  {
    id: 561,
    categorie: "Guerre / Moyen Âge",
    famille: "guerre",
    titre: "Bataille de Poitiers, Charles Martel arrête l'avancée musulmane",
    date: 732,
    emoji: "⚔️",
    image: "id-561.jpg",
    description_courte: "Charles Martel repousse une armée omeyyade près de Poitiers, stoppant sa progression vers le nord de l'Europe.",
    description_longue: "À la tête des armées franques, Charles Martel affronte et repousse près de Poitiers une expédition omeyyade venue d'Espagne sous le commandement d'Abd al-Rahman. Longtemps présentée comme la bataille ayant « sauvé » la chrétienté occidentale d'une conquête musulmane, son importance stratégique réelle reste débattue par les historiens contemporains, qui la considèrent plutôt aujourd'hui comme un raid de grande ampleur repoussé, l'un des multiples affrontements de la période.",
    anecdote: "C'est cette victoire qui vaudra à Charles son surnom de « Martel » (le marteau), en référence à la puissance de ses coups portés à l'ennemi.",
    fiabilite: "debattu",
    difficulte: "moyenne",
    liens: [{"type": "wikipedia", "label": "Wikipédia : Bataille de Poitiers, Charles Martel arrête l'avancée musulmane", "url": "https://fr.wikipedia.org/wiki/Bataille_de_Poitiers_(732)"}]
  },
  {
    id: 562,
    categorie: "Histoire / Architecture",
    famille: "histoire",
    titre: "Fondation de Bagdad, capitale du califat abbasside",
    date: 762,
    emoji: "📜",
    image: "id-562.jpg",
    description_courte: "Le calife abbasside al-Mansur fonde Bagdad, qui devient en quelques décennies l'une des plus grandes villes du monde.",
    description_longue: "Le calife abbasside al-Mansur fait construire sur les rives du Tigre une nouvelle capitale, conçue selon un plan circulaire parfait entouré de remparts concentriques. Bagdad devient rapidement l'une des cités les plus peuplées et les plus prospères du monde, cœur battant d'un âge d'or scientifique, littéraire et artistique du monde islamique qui durera plusieurs siècles.",
    anecdote: "Ce plan circulaire original, connu sous le nom de « ville ronde », a totalement disparu aujourd'hui, mais on peut encore en deviner la trace dans le tracé de certaines rues du centre historique de Bagdad.",
    fiabilite: "avere",
    difficulte: "difficile",
    liens: [{"type": "wikipedia", "label": "Wikipédia : Fondation de Bagdad, capitale du califat abbasside", "url": "https://fr.wikipedia.org/wiki/Bagdad"}]
  },
  {
    id: 563,
    categorie: "Science / Mathématiques",
    famille: "science",
    titre: "Al-Khwarizmi fonde l'algèbre",
    date: 820,
    emoji: "🔬",
    image: "id-563.jpg",
    description_courte: "À Bagdad, le savant Al-Khwarizmi publie un traité fondateur qui donnera son nom à l'algèbre moderne.",
    description_longue: "À la Maison de la Sagesse de Bagdad, le mathématicien et astronome Al-Khwarizmi rédige un traité systématique de résolution d'équations intitulé Kitab al-jabr wa al-muqabala, dont le titre donnera naissance au mot « algèbre ». Son ouvrage transmet également en Europe les chiffres indiens et leur système décimal positionnel, révolutionnant durablement les mathématiques occidentales.",
    anecdote: "Le mot « algorithme », omniprésent aujourd'hui en informatique, vient directement de la latinisation de son nom, « Algoritmi ».",
    fiabilite: "debattu",
    difficulte: "difficile",
    liens: [{"type": "wikipedia", "label": "Wikipédia : Al-Khwarizmi fonde l'algèbre", "url": "https://fr.wikipedia.org/wiki/Muhammad_ibn_Musa_al-Khuwarizmi"}]
  },
  {
    id: 564,
    categorie: "Invention / Guerre",
    famille: "inventions",
    titre: "Invention de la poudre à canon en Chine",
    date: 850,
    emoji: "⚙️",
    image: "id-564.jpg",
    description_courte: "En cherchant un élixir d'immortalité, des alchimistes chinois découvrent accidentellement la poudre à canon.",
    description_longue: "Des alchimistes taoïstes chinois, cherchant à concocter un élixir d'immortalité en mélangeant salpêtre, soufre et charbon de bois, découvrent par accident un composé hautement inflammable et explosif : la poudre à canon. D'abord utilisée pour des feux d'artifice et des armes incendiaires rudimentaires, elle transformera radicalement l'art de la guerre à travers le monde une fois adaptée aux armes à feu, plusieurs siècles plus tard.",
    anecdote: "Un traité alchimique chinois du IXe siècle met explicitement en garde contre ce mélange, rapportant que plusieurs alchimistes s'étaient déjà brûlé le visage et les mains en l'expérimentant.",
    fiabilite: "debattu",
    difficulte: "moyenne",
    liens: [{"type": "wikipedia", "label": "Wikipédia : Invention de la poudre à canon en Chine", "url": "https://fr.wikipedia.org/wiki/Poudre_noire"}]
  },
  {
    id: 565,
    categorie: "Histoire / Commerce",
    famille: "histoire",
    titre: "La Chine émet le premier papier-monnaie officiel",
    date: 1023,
    emoji: "📜",
    image: "id-565.jpg",
    description_courte: "Sous la dynastie Song, le gouvernement chinois émet le jiaozi, premier billet de banque officiel de l'histoire.",
    description_longue: "Face à la pénurie de pièces de monnaie en métal et au poids peu pratique des lourdes pièces de fer utilisées dans certaines provinces, le gouvernement de la dynastie Song prend le contrôle de l'émission de billets, jusque-là gérée par des marchands privés, et crée le jiaozi, premier papier-monnaie officiel garanti par un État de l'histoire. L'innovation facilite considérablement le commerce à grande échelle dans tout l'empire.",
    anecdote: "Le voyageur vénitien Marco Polo, découvrant l'usage du papier-monnaie en Chine plus de deux siècles plus tard, en fut si étonné qu'il y consacra un chapitre entier de son célèbre récit de voyage.",
    fiabilite: "avere",
    difficulte: "difficile",
    liens: [{"type": "wikipedia", "label": "Wikipédia : La Chine émet le premier papier-monnaie officiel", "url": "https://fr.wikipedia.org/wiki/Jiaozi_(monnaie)"}]
  },
  {
    id: 566,
    categorie: "Histoire / Architecture",
    famille: "histoire",
    titre: "Fondation du royaume du Grand Zimbabwe",
    date: 1000,
    emoji: "📜",
    image: "id-566.jpg",
    description_courte: "En Afrique australe, le royaume du Grand Zimbabwe bâtit une impressionnante cité de pierre sans mortier.",
    description_longue: "Sur le plateau du Zimbabwe actuel, un royaume shona prospère grâce au commerce de l'or et de l'ivoire avec la côte swahilie de l'océan Indien, et fait construire la cité du Grand Zimbabwe, dont les imposantes murailles de granit assemblées sans mortier restent l'une des plus grandes constructions précoloniales d'Afrique subsaharienne. Le pays moderne du Zimbabwe tire directement son nom de ce site.",
    anecdote: "Pendant la colonisation, certains archéologues européens refusèrent longtemps de croire que des bâtisseurs africains avaient pu ériger un tel monument, en attribuant à tort la construction à des civilisations étrangères — une théorie aujourd'hui totalement réfutée.",
    fiabilite: "debattu",
    difficulte: "difficile",
    liens: [{"type": "wikipedia", "label": "Wikipédia : Fondation du royaume du Grand Zimbabwe", "url": "https://fr.wikipedia.org/wiki/Grand_Zimbabwe"}]
  },
  {
    id: 567,
    categorie: "Exploration",
    famille: "exploration",
    titre: "Erik le Rouge découvre le Groenland",
    date: 982,
    emoji: "🧭",
    image: "id-567.jpg",
    description_courte: "Banni d'Islande pour meurtre, le Viking Erik le Rouge explore et colonise le Groenland.",
    description_longue: "Exilé d'Islande après avoir été reconnu coupable de meurtre, le chef viking Erik le Rouge explore une vaste terre inconnue plus à l'ouest et y établit les premières colonies norroises. Il baptise cette terre glacée « Groenland » (terre verte), un nom volontairement trompeur destiné à attirer de nouveaux colons islandais vers ce territoire rude.",
    anecdote: "Erik le Rouge choisit ce nom flatteur en pleine connaissance de cause : selon la saga qui rapporte son histoire, il estimait que les gens seraient plus enclins à s'y installer si la terre portait un nom séduisant.",
    fiabilite: "avere",
    difficulte: "moyenne",
    liens: [{"type": "wikipedia", "label": "Wikipédia : Erik le Rouge découvre le Groenland", "url": "https://fr.wikipedia.org/wiki/%C3%89rik_le_Rouge"}]
  },
  {
    id: 568,
    categorie: "Exploration",
    famille: "exploration",
    titre: "Leif Erikson atteint l'Amérique du Nord",
    date: 1000,
    emoji: "🧭",
    image: "id-568.jpg",
    description_courte: "Le navigateur viking Leif Erikson aborde les côtes d'Amérique du Nord, près de cinq siècles avant Christophe Colomb.",
    description_longue: "Fils d'Erik le Rouge, le navigateur norrois Leif Erikson part du Groenland et atteint les côtes d'Amérique du Nord, qu'il baptise Vinland en raison des vignes sauvages qui y poussent. Le site archéologique de L'Anse aux Meadows, à Terre-Neuve, confirme aujourd'hui la présence viking en Amérique du Nord bien avant l'arrivée de Christophe Colomb, même si cette installation resta temporaire et sans suite durable.",
    anecdote: "Le site de L'Anse aux Meadows, découvert en 1960, demeure à ce jour le seul campement viking en Amérique du Nord formellement authentifié par l'archéologie.",
    fiabilite: "debattu",
    difficulte: "moyenne",
    liens: [{"type": "wikipedia", "label": "Wikipédia : Leif Erikson atteint l'Amérique du Nord", "url": "https://fr.wikipedia.org/wiki/Leif_Erikson"}]
  },
  {
    id: 569,
    categorie: "Guerre / Moyen Âge",
    famille: "guerre",
    titre: "Prise de Jérusalem lors de la première croisade",
    date: 1099,
    emoji: "⚔️",
    image: "id-569.jpg",
    description_courte: "Au terme d'un siège meurtrier, les armées croisées s'emparent de Jérusalem et y fondent un royaume latin.",
    description_longue: "Répondant à l'appel du pape Urbain II, les armées de la première croisade traversent l'Europe et le Proche-Orient pour finalement s'emparer de Jérusalem après un siège sanglant, massacrant une grande partie de la population de la ville. Les croisés y fondent le royaume latin de Jérusalem, qui subsistera près de deux siècles avant d'être finalement repris par les forces musulmanes.",
    anecdote: "Godefroy de Bouillon, l'un des principaux chefs de la croisade, refusa de porter le titre de roi dans la ville où le Christ avait, selon la tradition chrétienne, porté une couronne d'épines, préférant celui plus modeste d'« avoué du Saint-Sépulcre ».",
    fiabilite: "avere",
    difficulte: "moyenne",
    liens: [{"type": "wikipedia", "label": "Wikipédia : Prise de Jérusalem lors de la première croisade", "url": "https://fr.wikipedia.org/wiki/Si%C3%A8ge_de_J%C3%A9rusalem_(1099)"}]
  },
  {
    id: 570,
    categorie: "Histoire / Culture",
    famille: "histoire",
    titre: "Fondation de l'université de Bologne, la plus ancienne d'Europe",
    date: 1088,
    emoji: "📜",
    image: "id-570.jpg",
    description_courte: "À Bologne, des étudiants s'organisent en corporation autour de maîtres de droit, donnant naissance à la première université d'Europe.",
    description_longue: "À Bologne, en Italie, des étudiants venus de toute l'Europe se regroupent en corporations autonomes autour de célèbres maîtres enseignant le droit romain, donnant naissance à ce que l'on considère traditionnellement comme la plus ancienne université d'Europe encore en activité. Ce modèle d'organisation universitaire, où les étudiants disposaient d'une autonomie remarquable pour l'époque, inspirera rapidement la fondation d'autres grandes universités, comme celles de Paris ou d'Oxford.",
    anecdote: "À Bologne, ce sont à l'origine les étudiants eux-mêmes, organisés en corporation, qui embauchaient et payaient directement leurs professeurs — une situation inverse de celle des universités actuelles.",
    fiabilite: "debattu",
    difficulte: "difficile",
    liens: [{"type": "wikipedia", "label": "Wikipédia : Fondation de l'université de Bologne, la plus ancienne d'Europe", "url": "https://fr.wikipedia.org/wiki/Universit%C3%A9_de_Bologne"}]
  },
  {
    id: 571,
    categorie: "Guerre / Moyen Âge",
    famille: "guerre",
    titre: "Saladin reprend Jérusalem aux croisés",
    date: 1187,
    emoji: "⚔️",
    image: "id-571.jpg",
    description_courte: "Après sa victoire à Hattin, le sultan Saladin reconquiert Jérusalem, mettant fin à 88 ans de domination croisée.",
    description_longue: "Après avoir écrasé l'armée du royaume latin de Jérusalem à la bataille de Hattin, le sultan kurde ayyoubide Saladin assiège puis reprend Jérusalem, mettant fin à 88 années de domination croisée sur la ville sainte. Contrairement au massacre commis par les croisés en 1099, Saladin se montre remarquablement clément envers la population chrétienne vaincue, ce qui lui vaudra une réputation de chevalerie admirée jusque chez ses adversaires européens.",
    anecdote: "Cette reprise de Jérusalem provoqua un tel choc en Europe qu'elle déclencha aussitôt le lancement de la troisième croisade, menée notamment par Richard Cœur de Lion, qui affrontera longuement Saladin sans jamais parvenir à reprendre la ville.",
    fiabilite: "avere",
    difficulte: "moyenne",
    liens: [{"type": "wikipedia", "label": "Wikipédia : Saladin reprend Jérusalem aux croisés", "url": "https://fr.wikipedia.org/wiki/Si%C3%A8ge_de_J%C3%A9rusalem_(1187)"}]
  },
  {
    id: 572,
    categorie: "Science / Mathématiques",
    famille: "science",
    titre: "Fibonacci introduit les chiffres arabo-indiens en Europe",
    date: 1202,
    emoji: "🔬",
    image: "id-572.jpg",
    description_courte: "Dans son Liber Abaci, le mathématicien italien Fibonacci fait connaître à l'Europe les chiffres arabes et le zéro.",
    description_longue: "Ayant appris les mathématiques arabes lors de ses voyages en Afrique du Nord avec son père marchand, l'Italien Leonardo Fibonacci publie le Liber Abaci (« Livre du calcul »), dans lequel il présente au public européen le système de numération décimale positionnelle utilisant les chiffres arabo-indiens, bien plus pratique pour le calcul que les chiffres romains alors en usage.",
    anecdote: "Le même ouvrage contient également le fameux problème des lapins qui donne naissance à la célèbre suite de Fibonacci, omniprésente dans la nature, des coquillages aux graines de tournesol.",
    fiabilite: "avere",
    difficulte: "difficile",
    liens: [{"type": "wikipedia", "label": "Wikipédia : Fibonacci introduit les chiffres arabo-indiens en Europe", "url": "https://fr.wikipedia.org/wiki/Leonardo_Fibonacci"}]
  },
  {
    id: 573,
    categorie: "Invention / Santé",
    famille: "inventions",
    titre: "Invention des lunettes de vue en Italie",
    date: 1286,
    emoji: "⚙️",
    image: "id-573.jpg",
    description_courte: "Des artisans verriers italiens mettent au point les premières lunettes correctrices de la vue.",
    description_longue: "Dans le nord de l'Italie, probablement autour de Pise ou de Venise, des artisans verriers mettent au point les premières lunettes correctrices, formées de deux lentilles de verre montées sur une structure que l'on maintient devant les yeux. Cette invention, dont le nom exact de l'inventeur reste inconnu, changera profondément la vie des lettrés vieillissants, jusque-là contraints d'abandonner la lecture avec la baisse de leur vue.",
    anecdote: "Un moine dominicain italien prêchant en 1306 mentionne dans un sermon que cette invention n'avait alors même pas encore vingt ans, ce qui permet aux historiens de dater assez précisément son apparition.",
    fiabilite: "debattu",
    difficulte: "moyenne",
    liens: [{"type": "wikipedia", "label": "Wikipédia : Invention des lunettes de vue en Italie", "url": "https://fr.wikipedia.org/wiki/Lunettes"}]
  },
  {
    id: 574,
    categorie: "Histoire / Politique",
    famille: "histoire",
    titre: "Fondation de l'Empire ottoman par Osman Ier",
    date: 1299,
    emoji: "📜",
    image: "id-574.jpg",
    description_courte: "Le chef turc Osman Ier fonde un petit émirat en Anatolie qui deviendra l'Empire ottoman.",
    description_longue: "À la tête d'une petite principauté turque d'Anatolie occidentale, Osman Ier profite du déclin du pouvoir seldjoukide et byzantin pour étendre progressivement son territoire, posant les fondations de ce qui deviendra l'Empire ottoman. Cet empire, qui prendra Constantinople en 1453, s'étendra à son apogée sur trois continents et perdurera jusqu'au lendemain de la Première Guerre mondiale, en 1922.",
    anecdote: "Selon une légende ottomane tardive, Osman aurait eu, la nuit précédant la fondation de son émirat, un rêve prémonitoire dans lequel un arbre gigantesque poussait depuis son nombril pour couvrir le monde entier de son ombre.",
    fiabilite: "debattu",
    difficulte: "moyenne",
    liens: [{"type": "wikipedia", "label": "Wikipédia : Fondation de l'Empire ottoman par Osman Ier", "url": "https://fr.wikipedia.org/wiki/Osman_Ier"}]
  },
];
